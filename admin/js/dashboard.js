function booking_analytics(period=1){
    ...
    xhr.open("POST", "logic/dashboard.php",true);
    ...
    xhr.onload = function(){
        ...
        document.getElementById('active_amt').text= "$" + data.active_amt;
...
function user_analytics(period=1){
    ...
    xhr.onload = function(){
        ...
        document.getElementById('total_new_reg').textContent = data.total_amt_reg;
