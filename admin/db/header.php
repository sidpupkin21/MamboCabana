<div class="container-fluid bg-dark text-light p-3 d-flex align-items-center justify-content-between fixed-top">
        <h2 class="mb-0 h-font text-center">MAMBO CABANA</h2>
        <a href="logout.php" class="btn btn-light btn-sm">LOGOUT</a>
    </div>

    <div class="col-md-2 bg-dark border-top border-3 border-secondary" id="dashboard-menu">
