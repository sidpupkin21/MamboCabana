...
<body class="bg-light">
    ...
    <!--Add modal-->
    <div class="modal fade" id="add-room" data-backdrop="static" data-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" min="1" max="5" name="children" placeholder="0" class="form-control shadow-none" required>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Adults (max.)</label>
                                <input type="number" min="1" name="aults" placeholder="0" class="form-control shadow-none" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Children (max.)</label>
                                <input type="number" min="1" name="children" placeholder="0" class="form-control shadow-none" required>
                            </div>
                            <div class="col-12 mb-3">
                                <label class="form-label fw-bold">Features</label>
                                <div class="row">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn custome-bg text-light shadow-none">SUBMIT</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="modal fade" id="add-room" data-backdrop="static" data-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal content">
                <div class="modal-content">
                    <h5 class="modal-header">Room Name</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="border-bottom border-3 pb-3 mb-3">
                        <form id="add_image_form">
                            ...
                            <button class="btn custom-bg text-light shadow-none">ADD</button>
                            <input type="hidden" name="room_id">
                        </form>
                    </div>
                    <div class="table-responsive-lg" style="height: 350px; overflow-y:scroll;">
                        <table class="table table-hover border text-center">
                            <thead>
                                <tr class="bg-dark texxt-light sticky-top">
