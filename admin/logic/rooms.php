...
if (isset($_POST['add_room'])) {
    ...
    // $q2 = "INSERT INTO `room_facilities`(`facilities_id`, `room_id`) VALUES (?,?)";
    // if ($stmt = mysqli_prepare($conn, $q2)) {
    //     foreach ($facilities as $f) {
    //         mysqli_stmt_bind_param($stmt, 'ii', $room_id, $f);
    //         mysqli_stmt_execute($stmt);
    ...
    //     die('ERROR INSERTING');
    // }
    // $q3 = "INSERT INTO `room_features`(`features_id`, `room_id`) VALUES (?,?)";
    // if ($stmt = mysqli_prepare($conn, $q3)) {
    //     foreach ($features as $f) {
    //         mysqli_stmt_bind_param($stmt, 'ii', $room_id, $f);
    //         mysqli_stmt_execute($stmt);
...
if (isset($_POST['remove_room'])) {
    ...
    $res5 = update("DELETE FROM `rooms` WHERE `id`=?",[$frm_data['room_id']],'i');
