            ...
            <div class="row align-items-baseline justify-content-between">
                ...
                <div class="col-5 col-sm-4 col-lg-3">
                    <div class="single-footer-widget mb-80">
                        ...
                        <ul class="footer-nav">
                            <li style="list-style-type: none;"><a href="#"><iconify-icon icon="bi:caret-right"></iconify-icon>Rooms & Suites</a></li>
                            <li style="list-style-type: none;"><a href="#"><iconify-icon icon="bi:caret-right"></iconify-icon>Activities</a></li>
                            <li style="list-style-type: none;"><a href="#"><iconify-icon icon="bi:caret-right"></iconify-icon>Facilities</a></li>
                            <li style="list-style-type: none;"><a href="#"><iconify-icon icon="bi:caret-right"></iconify-icon>Location & Tips</a></li>
                            <li style="list-style-type: none;"><a href="#"><iconify-icon icon="bi:caret-right"></iconify-icon>Client Reviews</a></li>
                            <li style="list-style-type: none;"><a href="#"><iconify-icon icon="bi:caret-right"></iconify-icon>Contact</a></li>
                        </ul>
                    </div>
                </div>
