...
<head>
    ...
    <title><?php echo $settings_r['site_logo'] ?> - ROOMS </title>
...
<body class="bg-light">
    ...
    <script>
        ...
        function fetch_rooms() {
            ...
            xhr.open("GET", "logic/rooms.php?fetch_rooms&chk_avail=" + chk_avail + "&guests=" + guests + "&facility_list=" + facility_list, true);
